...
%mongoDir%\mongorestore --drop --db %sub%phene %serverDir%\changelog\webClientChanges.bson

echo updating server changelog
%mongoDir%\mongorestore --drop --db %sub%phene %serverDir%\changelog\serverChanges.bson
